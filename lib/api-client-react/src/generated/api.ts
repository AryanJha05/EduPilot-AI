 ...
 */
export const getRecommendUniversitiesUrl = () => {
  return `/api/universities/recommend`;
};
...
export const recommendUniversities = async (
  ...
  return customFetch<RecommendationResponse>(getRecommendUniversitiesUrl(), {
    ...options,
    method: "POST",
...
export const getRecommendUniversitiesMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof recommendUniversities>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["recommendUniversities"];
  ...
  > = (props) => {
    ...
    return recommendUniversities(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type RecommendUniversitiesMutationResult = NonNullable<
  Awaited<ReturnType<typeof recommendUniversities>>
>;
export type RecommendUniversitiesMutationBody = BodyType<StudentProfile>;
export type RecommendUniversitiesMutationError = ErrorType<unknown>;

/**
 * @summary Get university recommendations based on student profile
 */
export const useRecommendUniversities = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getRecommendUniversitiesMutationOptions(options));
};
